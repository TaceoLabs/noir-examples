...
+-------------------+------------------------+--------------+----------------------+
| example_aes       | PLONKCSat { width: 3 } | 51883        | 295489               |
+-------------------+------------------------+--------------+----------------------+
...
## Noir Versions
```
nargo version = 0.19.4
noirc version = 0.19.4+4d133c50a50f21ca23861a9d1987207bd8783d36
(git version hash: 4d133c50a50f21ca23861a9d1987207bd8783d36, is dirty: false)
```
## Crate Versions
```
